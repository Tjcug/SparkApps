...
/**
 * OilfieldZhhslCluster entity. @author MyEclipse Persistence Tools
 */

public class OilfieldZhhslCluster implements java.io.Serializable {
	...
	/** default constructor */
	public OilfieldZhhslCluster() {
	}

	/** full constructor */
	public OilfieldZhhslCluster(String nf, Integer clusterId,
			String clusterType, double clusterCost, String yqtbm, String yqtmc,
			String pdmc, String yqclx, double zhhsl) {
		this.nf = nf;
